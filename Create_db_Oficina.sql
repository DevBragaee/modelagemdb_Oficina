-- Modelo de negocio  OFICINA MECÂNICA - Desafio DIO_oficina
...
alter table Conta auto_increment=1;
     -- supondo que ha clientes com contas fisicas e juridicas
...
create table Veiculo(
    ...
    Marca enum('Fiat','Volkswagen','Chevrolet','Ford','Renault','Toyota',
				'Kia','Nissan', 'Jeep', 'Peugeot','Citroen','Honda','Hyundai'),
	Modelo enum('Celta','Corsa','Gol','Fox','Uno','Palio','CrossFox','Voyage','Golf','Polo',
				'Siena','Fiesta','KA',
                'Civic','Fit','City','HB20','Corolla','Etios',
                'Sandero','Kwid','Logan'),
...
create table Equipe(
    ...
    Especialidade enum('Mecânico 1','Auxiliar 1','Auxiliar 2','Funilaria','Pintura'),
